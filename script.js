...
cards.forEach((card, index) => {
  ...
  card.querySelector('.card-front .foreign-word').textContent = wordData.originalWord;
  card.querySelector('.card-back .translation').textContent = wordData.translation;
  card.querySelector('.card-back .description').textContent = wordData.description;
